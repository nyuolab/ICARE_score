#!/bin/bash
#SBATCH --job-name=icare_radpref_allques
...
# =============================================================================
# RadPref ablation: evaluate ALL generated questions (skip report-dependent
# filtering). Reuses Step-1 mcqa_data.json from an existing filtered run.
#
# Does NOT modify icare_radpref.sh or overwrite filtered results.
#
# Usage (from ICARE_score repo root):
#   sbatch scripts/radpref_data/icare_radpref_allques.sh
#
#   # Or override paths:
#   sbatch --export=ALL,\
#     SRC_OUTPUT_DIR=/path/to/radpref/eval_seed_123,\
#     OUTPUT_DIR=/path/to/radpref_allques/eval_seed_123 \
#     scripts/radpref_data/icare_radpref_allques.sh
# =============================================================================
...
SRC_OUTPUT_DIR="${SRC_OUTPUT_DIR:-${ORIG_DIR}/outputs/radpref/eval_seed_${EVAL_SEED}}"
OUTPUT_DIR="${OUTPUT_DIR:-${ORIG_DIR}/outputs/radpref_allques/eval_seed_${EVAL_SEED}}"
...
echo "============================================="
echo "  ICARE RadPref — ALL QUESTIONS ablation"
echo "============================================="
echo "Source (Step 1 JSON): ${SRC_OUTPUT_DIR}"
echo "Output dir:           ${OUTPUT_DIR}"
echo "Input CSV:            ${NORMALIZED_INPUT_CSV}"
...
echo ""
echo "============================================="
echo "  RadPref all-questions ablation completed."
echo "============================================="
echo "Key files:"
echo "  - ${MANIFEST}"
