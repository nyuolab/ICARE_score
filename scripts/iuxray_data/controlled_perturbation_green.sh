...
#SBATCH --job-name ctrl_perturb_green
#SBATCH --output logs/ctrl_perturb_green_%A_%a.log
#SBATCH --mail-type END,FAIL
#SBATCH --mail-user rd3571@nyu.edu
#SBATCH --array=0-14   # 15 tasks: 3 conditions × 5 rates

# =============================================================================
# GREEN evaluation for the controlled matched deletion experiment (maira-2).
...
if ! python -c "import torch, transformers" 2>/dev/null; then
    echo "Error: regularization env missing GREEN dependencies."
    exit 1
fi
...
DONE_FLAG="${GREEN_DIR}/summary_of_averages.csv"
